	...
	<div class="row col-md-12 shadow-lg p-3 mb-5 bg-white rounded">
		...
		<div class="col-md-4 ">
			<div class="card" style="width: 18rem;">
			  <div class="card-body">
			    <h5 class="card-title">Add Tree Information</h5>
		...
		<div class="col-md-4 ">
			<div class="card" style="width: 18rem;">
			  <div class="card-body">
			    <h5 class="card-title">Show Tree Catalog</h5>
	...
	<div class="row col-md-12 shadow-lg p-3 mb-5 bg-white rounded">
		...
		<div class="col-md-4 ">
			<div class="card" style="width: 18rem;">
			  ...
			  <div class="card-body">
			    <h5 class="card-title">Planted Trees</h5>
		...
		<div class="col-md-4">
			<div class="card" style="width: 18rem;">
			  ...
			  <div class="card-body">
			    <h5 class="card-title">Show Sapling Contribution </h5>
			    <p class="card-text">User Profile information where user is able to see his/her info</p>
			    <a href="profile.php" class="btn btn-primary">Profile</a>
			  </div>
			</div>
		...
		<div class="col-md-4 ">
			<div class="card" style="width: 18rem;">
			    <div class="card-body">
			    <h5 class="card-title"> Show Available Location </h5>
			    <p class="card-text">Available Location where users can plant trees</p>
			    <a href="show_locations.php" class="btn btn-primary">Show Locations</a>
			  </div>
