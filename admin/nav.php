...
<nav class="navbar navbar-expand-lg navbar-light bg-dark text-white">
  <a class="navbar-brand  text-white" href="sidebar.php"><img src="../img/logo.png" height="50" width="50" />LetsGoGreen (Adminstrator)</a>
  ...
  <div class="collapse navbar-collapse  mr-auto   " id="navbarNav">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link  text-white" href="treeinfo.php">Add Tree Information</a>
      </li>
